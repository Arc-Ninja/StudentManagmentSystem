    ...
    public void actionPerformed(ActionEvent event){
        ...
        if(event.getSource()==this.entry.submit){
            try{
                ...
                if(Integer.parseInt(this.entry.studentRresgister.TRegister.getText())<=0){
                ...
                if(this.entry.studentGender.gender.getSelection()==null){
                    throw new EmptyGender("student gender is empty");
                }
                ...
                student = new Student(register, studentName, studDOB, gender,address, fatherName,motherName,Contact);
